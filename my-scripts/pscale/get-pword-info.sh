...
if [ "${output}" != null ]; then
  ...
  export EXISTING_PWORD_NAME=$4
else
  export EXISTING_PWORD_ID=""
  export EXISTING_PWORD_NAME=""
fi

echo "EXISTING_PWORD_ID: ${EXISTING_PWORD_ID}"
echo "EXISTING_PWORD_NAME: ${EXISTING_PWORD_NAME}"

echo "EXISTING_PWORD_ID=${EXISTING_PWORD_ID}" >> $GITHUB_OUTPUT
echo "EXISTING_PWORD_NAME=${EXISTING_PWORD_NAME}" >> $GITHUB_OUTPUT

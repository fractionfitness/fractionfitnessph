...
function Member({ member }) {
  return (
    <div className="w-fit flex flex-row space-x-2 space-y-2">
      <p></p>
      <p className="border border-white rounded-lg p-1">
        {member.userProfile.full_name}
      </p>
      <p className="border border-white rounded-lg p-1">{member.group.name}</p>
      <p className="border border-white rounded-lg p-1">{member.role}</p>
      {/* add this column */}
      {/* <p>member_status</p> */}
